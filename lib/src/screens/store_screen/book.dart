class Book {
  ...
  Book.fromSessionStorage(Map entry) :
        title = entry['title'],
        author = entry['author'],
        genres = (entry['genres'] as List)
  ...
  Map<String, dynamic> get toSessionStorage => {'quantity': quantity,
...
List<Book> bookList = [
  ...
  Book(
    ...
    evaluation: '4.2',
    resume:
    'Novo Assassins Creed aposta nos piratas do século XVIII. Aguardado sexto romance da saga mistura exploração naval com combate e aventuras Com mais de 1 milhão de livros vendidos somente no Brasil, Assassins Creed é uma das séries mais bem-sucedidas da atualidade. O novo e sexto título da saga, Bandeira Negra, passado em 1715, retrata a Era de Ouro da Pirataria numa primorosa reconstituição de época. Aqui, acompanhamos a trajetória de Edward Kenway (pai de Haytham Kenway e avô de Connor Kenway, personagens apresentados aos leitores em Assassins Creed: Renegado), desde sua decisão por abandonar a família até se tornar um dos mais temidos e respeitados corsários da época. Mas intrigas, traições e reviravoltas o espreitam em cada curva do caminho, e ele terá que optar entre seguir em frente ou saciar sua sede por vingança.',
    quantity: 14,
  ),
  Book(
